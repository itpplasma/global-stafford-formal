...
\end{quote}
The formal repository is public under Apache-2.0. Release \code{v1.0.3} fixes the submission module collision and records the completed replay. No hosted Palomar acceptance or human referee report is claimed.

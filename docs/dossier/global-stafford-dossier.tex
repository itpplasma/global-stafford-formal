...
Release \code{v1.0.0} retains the project proof sources and upgrades the dependency pins. Replay with the new pins is pending; the author requested publication for Palomar submission before that replay.
...
The dependencies listed below are the new release pins, not the historical report pins. Replay with these pins is pending. This dossier reports the historical evidence; it is not a new independent
...
\end{quote}
The formal repository is public under Apache-2.0. Release \code{v1.0.0}
is authorized for immediate publication and Palomar submission. The new-pin
replay remains pending; no Palomar acceptance or human referee report is claimed.

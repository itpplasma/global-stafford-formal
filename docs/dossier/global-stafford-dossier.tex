...
\newcommand{\leanref}[2]{\par\smallskip\noindent\textbf{Lean.} \href{https://github.com/itpplasma/global-stafford-formal/blob/d76051ce227f41c0fb21f114ffd61890f3b6b99b/#1}{\nolinkurl{#1}}.\par\noindent\small\code{#2}\par\normalsize\backmap}
...
This companion explains the finished formalization of the source-changing descent
proof. It states the mathematical claim in TeX, compares every part with the
Mathlib-only Challenge, and identifies the mechanisms that produce the global
certificate. The canonical paper source is the Markdown note
\code{notes/source-changing-descent-2026-09-07.md} in the research repository;
this document is a TeX exposition and correspondence dossier, not a separate
...
formal proof is \nolinkurl{d76051ce227f41c0fb21f114ffd61890f3b6b99b}.
The later formal revision \code{803fb2b} has identical proof and dependency bytes.
Phase I and II are complete in that record. Human expert review of the paper and
its statement correspondence remains open.

\section{TeX statement compared with Challenge.lean}\label{sec:comparison}
...
\code{GlobalStafford/Assembly/ChallengeTransport.lean}; \code{Solution.lean}
imports the substantive closure and uses the transported theorem. It never
imports \code{Challenge.lean}. Comparator checks the Challenge and Solution
...
\nolinkurl{784b59925beb9a480519142336bd6434f6eeef16}, declaration
...
The repository report \code{docs/verification-results.json} records a fresh
clone replay on 7 September 2026: source builds, endpoint axiom reports,
consumer checks, separate import-closure audits, Comparator, NanoDa, and the
Lean kernel all passed. Its SHA-256 is
\nolinkurl{cceb030147fac5e2d7e614ed879318595551aa5330c8e92d9bb5dfdf092d10f6}.
This dossier reports that fixed evidence; it is not a new independent
mathematical review or a new Palomar registration.

\begin{description}
\item[Lean] \code{leanprover/lean4:v4.33.0}
\item[Mathlib] \nolinkurl{db584cd6d46c92f209a44c0f1c829460d327499d}
\item[AlgebraicAnalysis] \nolinkurl{faa64814d5a310dc925e330af58e000f129f1098}
\item[Stafford38 formal] \nolinkurl{784b59925beb9a480519142336bd6434f6eeef16}
\end{description}
...
supplement. The Stafford38 GitHub release history lists \code{v1.0.2} as its
latest release on inspection; its citation file records concept DOI
\href{https://doi.org/10.5281/zenodo.22390721}{10.5281/zenodo.22390721} and the
version DOI \href{https://doi.org/10.5281/zenodo.22391362}{10.5281/zenodo.22391362}
for \code{v1.0.1}. The inspection does not assign a DOI to \code{v1.0.2}.
These identify Stafford38, not Global Stafford.
...
\end{quote}
The formal repository is private at preparation time. A Global Stafford
release tag, Zenodo DOI, and Palomar registration have not been issued in the
record used here. The release runbook separates selecting and hashing the
artifacts from the later visibility, signing, and deposit actions.
...
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,
 frame=lines,numbers=left,numbersep=5pt]{../../Challenge.lean}
...
\VerbatimInput[fontsize=\small,breaklines=true,breakanywhere=true,
 frame=lines,numbers=left,numbersep=5pt]{../../Solution.lean}
\VerbatimInput[fontsize=\small,breaklines=true,breakanywhere=true,
